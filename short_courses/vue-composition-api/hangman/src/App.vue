...
import Figure from './components/TheFigure.vue'
import WrongLetters from './components/TheWrongLetters.vue'
import Word from './components/TheWord.vue'
import Popup from './components/ThePopup.vue'  
