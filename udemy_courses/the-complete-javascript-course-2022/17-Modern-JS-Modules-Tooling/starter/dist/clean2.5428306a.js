...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"clean2.js":[function(require,module,exports) {
'use strict';
...
function addExpense(state, limit, value, description) {
  var user = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'jonas';
  var cleanUser = user.toLowerCase(); // Optional Chaining and Nullish Coalescing

  var getLimit = limit?.[cleanUser] ?? 0;
...
function checkExpenses(state, limit) {
  return state.map(function (expance) {
    var el = _objectSpread({}, expance);

    var getLimit = limit?.[el.user] ?? 0;
...
function logBigExpenses(bigLimit) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      output += el.value <= -bigLimit ? "".concat(el.description.slice(-2), " / ") : '';
    } // Remove last '/'
...
console.log(checkExpenses(newbudget3, spendingLimits)); // _____________________________________________________________________
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","clean2.js"], null)
//# sourceMappingURL=/clean2.5428306a.js.map