...
export default {
    ...
    getters: {
        ...
        firebaseBaseUrl(state) {
            return state.firebaseBaseUrl;
        },
        shouldUpdate(state) {
    ...
    actions: {
        ...
        async registerCoach(context, payload) {
            ...
            const firebaseBaseUrl = context.getters.firebaseBaseUrl;
            const url = `${process.env.VUE_APP_FIREBASE_URL}/coaches/${userId}.json`;
