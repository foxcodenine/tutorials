<template>
	<section class="container">
		...
		<user-data class="test" v-bind:first-name="firstName" v-bind:last-name="lastName"></user-data>
...
<script>
	/* eslint-disable */
import { ref, reactive, computed, watch, provide, isRef, isReactive, toRefs } from 'vue';
