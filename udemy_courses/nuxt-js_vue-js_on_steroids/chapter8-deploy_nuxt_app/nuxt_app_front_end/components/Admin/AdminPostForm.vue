...
export default {
    ...
    data() {
        return {
            ...
            postURL: this.updatePost ? `${this.$config.baseUrlFlask}/nuxtAPI/update/${this.$route.params.postId}/` : `${this.$config.baseUrlFlask}/nuxtAPI/`,
    ...
    methods: {
        ...
        onSave() {
            ...
            fetch(this.updatePost ? `${this.$config.baseUrlFlask}/nuxtAPI/update/${email}/${tokenFlask}/${this.flaskId}/` : `${this.$config.baseUrlFlask}/nuxtAPI/add/${email}/${tokenFlask}`, {
                ...
                setTimeout(()=>{
                    ...
                    .then(result => {
                        ...
                        this.flashMessage.info({
                            ...
                            message: `Author: ${this.editPost.author}, Title: ${this.editPost.title}`,
                            time: 10000,
        ...
        onDelete() {
            ...
            if (confirm("Press 'OK' to delete post, else press 'Cancel'")) {
                ...
                fetch(`${this.$config.baseUrlFlask}/nuxtAPI/update/${email}/${tokenFlask}/${this.flaskId}/`, {
                    method: 'DELETE',
