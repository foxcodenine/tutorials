<template>
    <div class="formbox" >
        ...
        <div class="formbox__content">
            <input class="full-span" type="email" placeholder="Email">
            <input class="full-span" type="password" placeholder="Password">
        </div>

        <button  class="btn formbox__btn mb-sm mt-sm-n" @click="submitForm()">
            Log In
        </button>
