  ...
  <div class="box">
    ...
    <div class="box__description">
      <div class="box__description-container">
        ...
        <div class="box__description-text">Code: {{status}}, Status: {{statusText}}</div>
      </div>
...
export default {
  ...
  mounted() {
        ...
        document.querySelector('.container').addEventListener('mousemove', e => {
          ...
          let halfX = pageX/2;
          let xAxis = ((e.pageX - halfX ) / halfX) * 30;

          let halfY = pageY/2;
          let yAxis = ((e.pageY - halfY ) / halfY) * 20;
        ...
        // Getting Code and Status:
        console.log( window.location.pathname)
        console.log( window.location.hostname)
        console.log( window.window.location.href)

        fetch(window.window.location.href)
        .then(res => {
          console.log(res);
