...
<div class="full-width-split__one">
    ...
    <!-- From Upcoming Evets end -------------------------------------->
    
    <!-- From Our Blogs start ----------------------------------------->
    <div class="full-width-split__two">
    <div class="full-width-split__inner">
        <h2 class="headline headline--small-plus t-center">From Our Blogs</h2>

        <?php $homepagePosts = new WP_Query(['posts_per_page' => 2 ]); ?>
        
        <?php while( $homepagePosts->have_posts() ):  $homepagePosts->the_post(); ?>
            <div class="event-summary">
                <a class="event-summary__date event-summary__date--beige t-center" href="<?= site_url(get_the_time('/Y/m/j')) ?>">
