...
class MyNotes {
  ...
  editNote(listElement) {
    listElement.dataset.state == 'readonly' ? this.makeNoteEditable(listElement) : this.makeNoteReadOnly(listElement);
  }
...
class Search {
  ...
  createList(name, field) {
    ...
    if (name === 'professors') {
      return `
            <ul class="professor-cards">
                ${field.map(item => `<li class="professor-card__list-item">
    ...
    if (name === 'events') {
      return `${field.map(item => `<div class="event-summary event-summary-min">
