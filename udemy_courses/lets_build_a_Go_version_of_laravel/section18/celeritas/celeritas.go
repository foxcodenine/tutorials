...
func (c *Celeritas) New(rootPath string) error {
	...
	// Initialize the mailer configuration and assign it to the Celeritas instance
...
// reateRenderer initializes and configures a new renderer based on the application's settings.
