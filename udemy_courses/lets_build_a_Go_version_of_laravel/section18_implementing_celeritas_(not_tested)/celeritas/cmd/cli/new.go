...
func doNew(appName string) {
	...
	_, err := git.PlainClone("./"+appName, false, &git.CloneOptions{
		URL:      "https://github.com/foxcodenine/tutorials",
		Progress: os.Stdout,
		Depth:    1,
	})
	if err != nil {
	...
	// Remove all directories and files except the desired folder (./bare)
	err = os.RemoveAll("./" + appName + "/udemy_courses/lets_build_a_Go_version_of_laravel/bare")
	if err != nil {
		log.Fatal(err)
	}
	if err != nil {
