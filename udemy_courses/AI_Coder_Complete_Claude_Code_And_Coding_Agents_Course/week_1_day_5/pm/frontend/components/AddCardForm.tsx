    ...
    >
      ...
      <div className="flex items-center gap-2 mt-2.5">
        <button
          type="submit"
          disabled={!title.trim()}
          className="px-3 py-1.5 bg-[#ecad0a] text-[#032147] text-xs font-semibold rounded hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed transition-opacity"
        >
          Add card
        </button>
        <button
