...
<html lang="en">
    ...
    <body class="container">
        ...
        <label for="menu-checkbox" class="menu__label"></label>       
        ...
        <footer class="footer">
            ...
            <p class="copyright">
                &copy; Copyright 2017 by Jonas Schmedtmann. Feel free to use this puoject for your own
                purposes. This does NOT apply if you plan to produce your own course or tutorials based on this project.
            </p>
        </footer>
