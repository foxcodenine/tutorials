        ...
        <div class="card card-body">
            <form action="">
                ...
                <div class="form-group">
                    ...
                    placeholder="Enter you e-mail" v-model="email"
                ...
                <div class="form-group mt-3">
                    ...
                    placeholder="Enter you password" v-model="password"
                ...
                <div>
                    No account yet?
                    <router-link :to="{name: 'home'}" class="fw-bold link-primary"> Register</router-link>
                </div>
