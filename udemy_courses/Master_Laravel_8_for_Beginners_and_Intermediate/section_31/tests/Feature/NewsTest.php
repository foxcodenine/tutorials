...
class NewsTest extends TestCase
{
    ...
    public function test_update_valid_news() {
        ...
        $newsPost = $this->createDummyNewsPost($testUser->id);  
        ...
        $str =  $newsPost->created_at->diffForHumans();

        $this->get("/news/{$newsPost->id}")->assertSeeText(($str));
    ...
    private function createDummyNewsPost($userId=null): NewsPost {
        ...
        $newsPost->user_id = $userId ?? (new User)->id;
