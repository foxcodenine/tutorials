...
Route::resource('test', TestControler::class)->only(['index']);
...
Route::post('/sendemail', [HomeController::class, 'send'])->name('home.sendEmail');
Route::get('/foxcode', function() { return redirect()->away('https://foxcode.io/');})->name('foxcode');
...
Route::get('mailable', function() {
    ...
    // This route is used to view the email before it is sent

    $comment = Comment::find(1);

    return new CommentPostedMarkdownMail($comment);
});
